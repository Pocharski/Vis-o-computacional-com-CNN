...
def treinar_modelo_transfer_learning(model_name, epochs_frozen, batch_size):
    ...
    print(f"\n--- Treinamento das Camadas DENSAS ({epochs_frozen} épocas) ---")
...
if __name__ == '__main__':
    ...
    # --- 🛑 MODO "GRID SEARCH COMPLETO" (36 EXECUÇÕES) 🛑 ---
    print("ATENÇÃO: Rodando 'GRID SEARCH COMPLETO' (36 execuções).")
    print("Redes: [MobileNetV2, ResNet50, VGG16, EfficientNetB0]")
    print("Épocas: [20, 50, 100] | Batch Sizes: [16, 32, 64]")
    print("Este processo levará MUITAS HORAS.")
    ...
    if all_results:
        ...
        print("\n🥇 MELHOR MODELO ENCONTRADO (BASEADO NO TREINO CONGELADO):")
